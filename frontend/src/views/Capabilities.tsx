      ...
      <div className="relative z-10 space-y-8 pt-40 pb-24 animate-in fade-in duration-1000">
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="bg-slate-900/40 backdrop-blur-2xl rounded-[4rem] p-8 md:p-32 text-center space-y-12 border border-white/5 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.8)] relative overflow-hidden">
            ...
            <Link to="/contact?type=general" className="inline-block px-12 py-6 bg-cyan-500 text-slate-900 font-black uppercase tracking-widest text-lg rounded-3xl shadow-xl shadow-cyan-500/20 hover:bg-white hover:scale-105 transition-all">
