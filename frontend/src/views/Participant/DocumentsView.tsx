...
const DocumentsView = ({ handleExportPDF, study }: { handleExportPDF: any; study?: any }) => {
    ...
    const documents: Document[] = [
        ...
        { id: '6', name: 'Microbiome Analysis Summary', category: 'Lab Reports', subcategory: 'Microbiome', uploadedBy: 'Study Team', date: '03/22/2026', status: 'Verified', size: '4.2 MB', type: 'csv' },
        { id: '7', name: 'Study Recruitment Flyer', category: 'Study Flyers', uploadedBy: 'Study Team', date: '02/15/2026', status: 'Verified', size: '1.5 MB', type: 'image' },
    ...
    const getStatusBadge = (status: string) => {
        switch (status) {
            case 'Signed': return <Badge color="indigo">Signed</Badge>;
            case 'Verified': return <Badge color="green">Verified</Badge>;
            case 'Important': return <Badge color="amber">Important</Badge>;
            case 'Pending': return <Badge color="red">Pending Action</Badge>;
                                                ...
                                                >
                                                    ...
                                                    <td className="px-8 py-6">
                                                        <div className="flex items-center justify-end gap-2">
                                                            ...
                                                            <button className="p-2.5 rounded-lg bg-white/5 text-slate-500 hover:text-white hover:bg-white/10 transition-all">
                                            ...
                                            >
                                                <Card className="p-6 h-full flex flex-col justify-between group hover:border-cyan-500/30 transition-all cursor-pointer relative overflow-hidden bg-[#0d1424]">
                                                    ...
                                                    <div className="relative z-10 flex items-center gap-2 pt-6 mt-6 border-t border-white/[0.05]">
                                                        ...
                                                        <button className="p-3 bg-white/5 hover:bg-white/10 text-slate-400 hover:text-white rounded-xl transition-all border border-white/10">
                                                            <Download className="w-3.5 h-3.5" />
                                                        </button>
                                                    </div>
                                                </Card>
