    ...
    const handleAction = async (doc: Document, action: 'VIEW' | 'DOWNLOAD') => {
        ...
        try {
            ...
            if (img.complete && img.naturalWidth > 0) {
                ...
                pdf.addImage(dataUrl, 'JPEG', 15, 12, 25, 25);
            }
        ...
        docDetails.forEach((row) => {
            ...
            pdf.text(row[1].toUpperCase(), 65, y);
            y += 8;
        });
        ...
        pdf.setFontSize(8);
        pdf.text("AUTHENTICATION ID: MUSB-" + Math.random().toString(36).substring(7).toUpperCase(), pageWidth / 2, 285, { align: 'center' });
