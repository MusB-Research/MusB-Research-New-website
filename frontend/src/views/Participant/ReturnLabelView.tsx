        ...
        <div className="flex flex-col gap-8 max-w-[1000px] mx-auto py-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex items-center justify-between px-2">
                ...
                <div className="flex gap-3">
                    ...
                    <a 
                         ...
                         className="flex items-center gap-2 px-6 py-3 bg-indigo-500 text-white rounded-xl text-[12px] font-black uppercase tracking-widest hover:bg-indigo-400 transition-all shadow-lg shadow-indigo-500/20"
                    >
                    ...
                    <div className="w-full flex items-center justify-between pb-8 border-b-4 border-slate-900 mb-8">
                         <div className="flex items-center gap-4">
                             ...
                             <div>
                                 ...
                                 <span className="text-[12px] font-black uppercase tracking-[0.4em]">Overnight Priority</span>
                             </div>
                         </div>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-2 gap-16 w-full mb-12">
                         <div className="space-y-4">
                             <div className="flex items-center gap-2 text-slate-400">
                                 <Badge color="gray" className="text-[12px] bg-slate-100 text-slate-900 border-none font-bold">FROM</Badge>
                         ...
                         <div className="space-y-4">
                             <div className="flex items-center gap-2 text-slate-400">
                                 <Badge color="gray" className="text-[12px] bg-slate-100 text-slate-900 border-none font-bold">SHIP TO</Badge>
                                 <span className="text-[12px] font-black uppercase tracking-widest leading-none">Central Processing Lab</span>
                             </div>
                             <div className="space-y-1">
                    ...
                    <div className="w-full flex justify-between items-end pt-12">
                         <div className="flex gap-4">
                             ...
                             <div className="flex flex-col justify-end space-y-2">
                                 ...
                                 <span className="text-[12px] font-black uppercase tracking-widest leading-none">SCAN FOR SYNC</span>
                             </div>
                         </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 opacity-60">
                <div className="p-8 bg-white/[0.02] border border-white/5 rounded-3xl space-y-4">
                    <h5 className="text-[12px] font-black text-white italic uppercase tracking-widest flex items-center gap-2">
                        <Package className="w-3 h-3 text-cyan-400" /> Secure Seal 
                    </h5>
                    <p className="text-[12px] font-bold text-slate-500 uppercase leading-relaxed italic">Ensure the bio-capsule is double-sealed before inserting into the padded mailer.</p>
                </div>
                <div className="p-8 bg-white/[0.02] border border-white/5 rounded-3xl space-y-4">
                    <h5 className="text-[12px] font-black text-white italic uppercase tracking-widest flex items-center gap-2">
                        <MapPin className="w-3 h-3 text-indigo-400" /> Drop-off Point
                    </h5>
                    <p className="text-[12px] font-bold text-slate-500 uppercase leading-relaxed italic">Drop off at any FedEx Priority hub. Do not use local drop boxes for biological samples.</p>
                </div>
                <div className="p-8 bg-white/[0.02] border border-white/5 rounded-3xl space-y-4">
                    <h5 className="text-[12px] font-black text-white italic uppercase tracking-widest flex items-center gap-2">
                        <Ship className="w-3 h-3 text-amber-400" /> Tracking Log
                    </h5>
                    <p className="text-[12px] font-bold text-slate-500 uppercase leading-relaxed italic">Once scanned, the dashboard will update to 'SHIPPED_PENDING' within 10 minutes.</p>
                </div>
            </div>
