...
const PrivacyDataView = ({ onAction }: { onAction: (t: string) => void }) => (
    <div className="max-w-[1500px]">
        <h2 className="text-4xl font-black italic tracking-tighter text-white uppercase mb-8">Privacy & Data</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="p-10 border-cyan-500/10">
                ...
                <button onClick={() => onAction('Export Data Summary')} className="w-full py-5 bg-white text-slate-950 rounded-2xl font-black text-xs uppercase tracking-widest shadow-2xl flex items-center justify-center gap-3">
                ...
                <Card className="p-8 hover:border-indigo-500/30 transition-all cursor-pointer group" onClick={() => onAction('View Data Access Logs')}>
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mt-1">See who has viewed your information.</p>
                        </div>
                    </div>
                </Card>
                <Card className="p-8 hover:border-amber-500/30 transition-all cursor-pointer group" onClick={() => onAction('Data Retention Settings')}>
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mt-1">Choose how long we keep your data.</p>
                        </div>
                    </div>
                </Card>
                <Card className="p-8 hover:border-red-500/30 transition-all cursor-pointer group" onClick={() => onAction('Request Data Deletion')}>
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-600 uppercase tracking-widest mt-1">Remove all your information from our systems.</p>
                        </div>
                    </div>
                </Card>
            </div>
