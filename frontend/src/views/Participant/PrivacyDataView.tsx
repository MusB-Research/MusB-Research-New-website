    ...
    <div className="max-w-[1500px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="p-10 border-cyan-500/10">
                ...
                <button onClick={() => onAction('Export Data Summary')} className="w-full py-5 bg-white text-slate-950 rounded-2xl font-black text-[12px] uppercase tracking-widest shadow-2xl flex items-center justify-center gap-3">
