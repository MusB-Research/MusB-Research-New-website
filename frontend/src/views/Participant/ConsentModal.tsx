                            ...
                            >
                                    ...
                                    <div className="prose prose-invert max-w-none space-y-8">
                                        ...
                                        <section className="space-y-4">
                                            <h5 className="text-[14px] font-black text-white uppercase italic tracking-widest flex items-center gap-2">
                                                <div className="w-1.5 h-1.5 bg-cyan-500 rounded-full" /> Study Purpose
                                            </h5>
                                        ...
                                        <section className="space-y-4">
                                            <h5 className="text-[14px] font-black text-white uppercase italic tracking-widest flex items-center gap-2">
                                                <div className="w-1.5 h-1.5 bg-cyan-500 rounded-full" /> Participation & Withdrawal
                                            </h5>
                                            <p className="text-slate-400 font-bold uppercase tracking-widest text-[12px] leading-relaxed pl-4 border-l border-white/5">
                                        ...
                                        <section className="space-y-4">
                                            <h5 className="text-[14px] font-black text-white uppercase italic tracking-widest flex items-center gap-2">
                                                <div className="w-1.5 h-1.5 bg-cyan-500 rounded-full" /> Data Protection
                                            </h5>
                                            <p className="text-slate-400 font-bold uppercase tracking-widest text-[12px] leading-relaxed pl-4 border-l border-white/5">
                                ...
                                <div className="mt-8 flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className={`px-10 py-4 rounded-xl font-black text-[14px] uppercase tracking-widest transition-all ${scrolledToBottom ? 'bg-cyan-500 text-slate-950 hover:bg-cyan-400 active:scale-95 shadow-lg shadow-cyan-500/20' : 'bg-white/5 text-slate-600 cursor-not-allowed border border-white/5'}`}
                                    >
                            ...
                            >
                                ...
                                <div className="w-full flex justify-between items-center mt-10">
                                    ...
                                    <button
                                        ...
                                        className={`px-12 py-5 rounded-2xl font-black text-[14px] uppercase tracking-[0.2em] transition-all ${hasSigned && !isSubmitting ? 'bg-cyan-500 text-slate-950 hover:bg-cyan-400 active:scale-95 shadow-xl shadow-cyan-500/20' : 'bg-white/5 text-slate-800 border border-white/5 cursor-not-allowed'}`}
                                    >
