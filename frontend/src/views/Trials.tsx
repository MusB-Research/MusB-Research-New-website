            ...
            <div className="relative z-10 pb-24 animate-in fade-in duration-1000">
                ...
                <section className="relative pt-40 pb-24 max-w-[1700px] mx-auto px-4 md:px-12 overflow-hidden">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
                        <div className="space-y-8">
                            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-amber-400/10 border border-amber-400/20 text-amber-400 font-bold text-[12px] tracking-widest uppercase">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tight leading-[0.85] uppercase italic">
                                Join a Study. Help Advance <span className="text-amber-400 italic font-black">Natural</span> Health Science.
                            </h1>
                            <ul className="space-y-4">
                                <li className="flex items-start gap-4 text-lg md:text-xl text-slate-300 font-medium">
                                    <div className="w-2 h-2 rounded-full bg-amber-500 mt-2.5"></div>
                            ...
                            <div className="flex flex-wrap gap-4 pt-4">
                                <a
                                    ...
                                    className="bg-amber-500 text-slate-900 px-8 py-4 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-white hover:-translate-y-1 transition-all shadow-xl shadow-amber-500/20 flex items-center gap-2"
                                >
                                    Check Eligibility
                            ...
                            <div className="flex items-center gap-8 pt-6">
                                <div className="flex items-center gap-2 text-[12px] font-black uppercase tracking-widest text-slate-400">
                                    <ShieldCheck className="w-4 h-4 text-amber-400" /> Confidential and secure
                                </div>
                                <div className="flex items-center gap-2 text-[12px] font-black uppercase tracking-widest text-slate-400">
                                    <Zap className="w-4 h-4 text-amber-400" /> Lab-tested products
                                </div>
                            </div>
                        </div>
                        <div className="relative">
                            <div className="absolute inset-0 bg-gradient-to-tr from-amber-500/20 to-indigo-500/20 rounded-[4rem] blur-3xl"></div>
                            <div className="relative grid grid-cols-2 gap-4">
                                <div className="space-y-4 pt-12">
                                    <div className="rounded-[3rem] w-full h-[300px] shadow-2xl border border-white/10 bg-gradient-to-br from-amber-500/20 to-indigo-500/20"></div>
                                    <div className="rounded-[3rem] w-full h-[200px] shadow-2xl border border-white/10 bg-gradient-to-tr from-indigo-500/20 to-amber-500/20"></div>
                                </div>
                                <div className="space-y-4">
                                    <div className="rounded-[3rem] w-full h-[200px] shadow-2xl border border-white/10 bg-gradient-to-br from-indigo-500/20 to-amber-500/20"></div>
                                    <div className="rounded-[3rem] w-full h-[300px] shadow-2xl border border-white/10 bg-gradient-to-tr from-amber-500/20 to-indigo-500/20"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-24 max-w-[1400px] mx-auto px-4 md:px-12" >
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="group bg-slate-900/40 backdrop-blur-3xl p-8 md:p-12 rounded-[4rem] border border-white/5 hover:border-amber-500/30 transition-all shadow-2xl">
                            <div className="w-16 h-16 rounded-2xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400 mb-8 group-hover:scale-110 transition-transform">
                            ...
                            <a href="#current-studies" className="bg-amber-500 text-slate-900 px-8 py-4 rounded-2xl font-black text-[12px] uppercase tracking-widest inline-block hover:bg-white transition-colors">Check Eligibility</a>
                        </div>
                ...
                <section id="how-it-works" className="bg-slate-950/40 backdrop-blur-2xl py-24 border-y border-white/5" >
                    <div className="max-w-[1400px] mx-auto px-4 md:px-12">
                        <div className="text-center space-y-6 max-w-3xl mx-auto mb-12 md:mb-24">
                            <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight uppercase">How the <span className="text-amber-400">Study Works</span></h2>
                        ...
                        <div className="p-8 md:p-16 rounded-[2.5rem] md:rounded-[4.5rem] bg-slate-900/40 border border-white/5 backdrop-blur-3xl relative overflow-hidden group/container">
                            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-amber-500/5 blur-[120px] rounded-full"></div>
                                ...
                                {[
                                    ...
                                    <div key={idx} className="relative group">
                                        <div className="relative z-10 space-y-6">
                                            <div className="w-16 h-16 rounded-2xl bg-amber-400 flex items-center justify-center text-slate-900 shadow-[0_0_20px_rgba(6,182,212,0.4)] group-hover:scale-110 transition-transform duration-500">
                                                <item.icon className="w-8 h-8" />
                                            </div>
                                            <div className="space-y-4">
                                                <div className="inline-block px-3 py-1 bg-white/5 rounded-lg text-[12px] font-black uppercase tracking-widest text-amber-500/60 transition-colors uppercase italic">{item.step}</div>
                                                <h4 className="text-xl font-black text-white uppercase group-hover:text-amber-400 transition-colors">{item.title}</h4>
                        ...
                        <div className="bg-slate-900/40 backdrop-blur-xl p-4 rounded-3xl border border-white/10 flex gap-4">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="pl-12 pr-6 py-3 bg-white/5 border border-white/10 rounded-2xl outline-none focus:border-amber-500 transition-all text-sm font-bold text-white placeholder:text-slate-600"
                                    value={searchQuery}
                    ...
                    <div className="flex flex-wrap gap-3 mb-12">
                        {conditions.map(c => (
                            <button
                                ...
                                className={`px-6 py-3 rounded-xl font-bold text-[12px] uppercase tracking-widest transition-all ${selectedCondition === c ? 'bg-amber-500 text-slate-900' : 'bg-white/5 text-slate-400 hover:bg-white/10'}`}
                            >
                                {c}
                            </button>
                        ))}
                    ...
                    <div className="relative bg-slate-950/40 backdrop-blur-xl rounded-3xl border border-white/10 p-8 md:pt-16 md:pb-8 md:px-16 overflow-hidden group/container">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 relative z-10">
                            {filteredStudies.map((study) => (
                                <div key={study.id} className="group border border-white/5 rounded-[3rem] p-6 md:p-10 bg-slate-900/40 hover:bg-slate-900 hover:border-amber-500/30 transition-all flex flex-col relative overflow-hidden shadow-2xl">
                                    <div className="absolute -inset-1 bg-gradient-to-tr from-amber-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"></div>
                                    <div className="flex justify-between items-start mb-8">
                                        <div className="space-y-4">
                                            <div className={`inline-block px-4 py-1.5 rounded-full text-[12px] font-black uppercase tracking-widest ${study.status === 'Recruiting' ? 'bg-amber-500/10 text-amber-400' :
                                            ...
                                            <h3 className="text-3xl font-black text-white group-hover:text-amber-400 transition-colors uppercase">{study.title}</h3>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                                        <div className="bg-white/2 rounded-2xl p-4 border border-white/5 flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-slate-500 group-hover:text-amber-400 transition-colors shrink-0">
                                    ...
                                    {study.status === 'Recruiting' ? (
                                        <Link
                                            to={`/studies/${study.id}`}
                                            className="block w-full text-center py-5 rounded-2xl font-black text-sm uppercase tracking-widest transition-all bg-amber-500 text-slate-900 hover:bg-white"
                                        >
                                            Join Study
                                        </Link>
                                    ) : (
                ...
                <section id="faq" className="pt-8 pb-24 max-w-[1000px] mx-auto px-4 md:px-12" >
                    ...
                    <div className="space-y-4">
                        {faqs.map((faq, idx) => (
                            <div key={idx} className="bg-slate-900/40 backdrop-blur-xl border border-white/5 rounded-3xl overflow-hidden hover:border-white/10 transition-all">
                                ...
                                >
                                    <span className="text-lg font-bold text-white group-hover:text-amber-400 transition-colors">{faq.q}</span>
                                    <ChevronDown className={`w-5 h-5 text-slate-400 transition-transform ${openFaq === idx ? 'rotate-180 text-amber-400' : ''}`} />
                                </button>
                                {openFaq === idx && (
                    ...
                    <div className="mt-16 text-center">
                        <a href="#current-studies" className="text-amber-400 font-black text-sm uppercase tracking-[0.2em] border-b-2 border-amber-400/30 pb-2 hover:border-amber-400 hover:text-white transition-all">Check Eligibility</a>
                    </div>
                </section >
