    ...
    return (
        <div className="min-h-screen pt-40 pb-24 px-4 md:px-12 bg-transparent text-slate-200">
            <div className="max-w-7xl mx-auto space-y-16">
                ...
                >
                    <Link to="/trials" className="flex items-center gap-2 text-sm font-black uppercase tracking-[0.4em] text-slate-500 hover:text-cyan-400 transition-all group">
                ...
                <div className="grid lg:grid-cols-12 gap-12 items-start">
                    ...
                    <div className="lg:col-span-8 space-y-12">
                        ...
                        <div className="space-y-8">
                            ...
                            >
                                <span className="px-4 py-1.5 bg-cyan-500/10 text-cyan-400 rounded-full text-sm font-black uppercase tracking-[0.2em] border border-cyan-500/30 backdrop-blur-md">
