    ...
    <div style={{
      ...
      <div style={{ paddingBottom: 16, borderBottom: '1px solid rgba(255,255,255,0.08)', marginBottom: 20 }}>
        ...
        <div style={{ background: 'rgba(30, 41, 59, 0.4)', backdropFilter: 'blur(10px)', borderRadius: 20, padding: windowWidth > 768 ? 16 : 12, marginTop: 16, display: 'flex', gap: 12, flexWrap: 'wrap', alignItems: 'center', border: '1px solid rgba(255,255,255,0.05)' }}>
          <input value={searchQuery} onChange={e => setSearchQuery(e.target.value)} placeholder="Search protocols..." style={{ flex: 1, minWidth: windowWidth > 768 ? 200 : '100%', background: 'rgba(15, 23, 42, 0.6)', border: '2px solid rgba(255,255,255,0.1)', color: '#f1f5f9', padding: windowWidth > 768 ? '18px 20px' : '14px 16px', borderRadius: 14, outline: 'none', fontSize: 16, fontWeight: 600 }} />
          <div style={{ position: 'relative', flex: windowWidth > 768 ? 'none' : 1 }}>
            <select
              ...
              style={{
                ...
                color: '#f1f5f9',
                padding: windowWidth > 768 ? '18px 48px 18px 20px' : '14px 40px 14px 16px',
                borderRadius: 14,
                fontSize: 16,
                fontWeight: 700,
                cursor: 'pointer',
          ...
          <div style={{ display: 'flex', gap: 12, width: windowWidth > 768 ? 'auto' : '100%', justifyContent: 'center' }}>
            <button onClick={() => setExpandedCards(new Set(filteredStudies.map((p: any) => p.id)))} style={{ background: 'transparent', border: '2px solid rgba(255,255,255,0.1)', color: '#f1f5f9', padding: windowWidth > 768 ? '18px 32px' : '14px 20px', borderRadius: 14, fontWeight: 700, cursor: 'pointer', fontSize: 16 }}>Expand All</button>
            <button onClick={() => setExpandedCards(new Set())} style={{ background: 'transparent', border: 'none', color: '#94a3b8', padding: '18px 16px', fontWeight: 700, cursor: 'pointer', fontSize: 16 }}>Collapse All</button>
          </div>
        </div>
                ...
                <div style={{ borderTop: '1px solid #334155' }}>
                  ...
                  <div style={{ padding: '32px 48px', borderBottom: '1px solid #334155' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 40 }}>
                      <div><div style={{ fontSize: 14, color: '#94a3b8', marginBottom: 10, fontWeight: 600 }}>Investigator</div><div style={{ fontSize: 20, color: '#f1f5f9', fontWeight: 700, letterSpacing: '-0.01em' }}>{study.pi}</div></div>
          ...
          <div>
            ...
            {(cardChartTabs[`detail_${activeStudyForDetail.id}`] || 'Overview') === 'Overview' && (
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '36px 56px' }}>
                <div><div style={{ fontSize: 12, color: '#64748b', textTransform: 'uppercase', fontWeight: 800, marginBottom: 10, letterSpacing: '0.08em' }}>Investigator</div><div style={{ fontSize: 22, color: '#f1f5f9', fontWeight: 700 }}>{activeStudyForDetail.pi}</div></div>
