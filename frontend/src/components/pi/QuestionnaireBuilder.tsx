                ...
                <div className="px-6 lg:px-10 py-6 lg:py-8 flex flex-col xl:flex-row items-center justify-between gap-8 xl:gap-8">
                    <div className="flex items-start gap-4 lg:gap-8 shrink-0">
                        ...
                        <div>
                            ...
                            <p className="text-[12px] lg:text-[12px] text-indigo-400 font-bold uppercase tracking-[0.2em] lg:tracking-[0.3em] italic opacity-80 max-w-2xl">Design logical recruitment funnels with dynamic branching and validation.</p>
                        </div>
                    </div>
