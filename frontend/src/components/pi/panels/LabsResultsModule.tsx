                                ...
                                <td className="px-10 py-10 text-right">
                                    <div className="flex items-center justify-end gap-3 transition-opacity">
                                        ...
                                        {(s.status === 'Resulted' || s.status === 'Alert') && (
                                            <button className="px-8 py-4 bg-white text-slate-950 rounded-2xl text-[12px] font-black uppercase tracking-widest flex items-center gap-3 hover:scale-[1.03] transition-all shadow-lg">
