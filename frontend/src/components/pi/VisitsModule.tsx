                ...
                <div className="flex flex-col md:flex-row md:items-center gap-3 lg:gap-8">
                    ...
                    <div className="flex bg-white/5 p-1 rounded-xl lg:rounded-2xl border border-white/5 self-start">
                        <button 
                            ...
                            className={`px-3 lg:px-4 py-1.5 lg:py-2 rounded-lg lg:rounded-xl text-[12px] lg:text-[12px] font-black uppercase tracking-widest transition-all ${
                ...
                <div className="flex flex-row items-stretch items-center gap-3 lg:gap-6">
                    <div className="relative flex-1 lg:w-64">
                        ...
                        <input 
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-xl lg:rounded-2xl pl-10 pr-4 py-2 lg:py-2.5 text-[12px] lg:text-[12px] text-white placeholder-slate-700 outline-none focus:border-indigo-500/50 uppercase tracking-widest"
                        />
                    </div>
                    <button 
                        onClick={() => setIsScheduleOpen(true)}
                        className="px-4 lg:px-6 py-2.5 lg:py-4 bg-indigo-600 text-white rounded-xl lg:rounded-2xl text-[12px] lg:text-[12px] font-black uppercase tracking-widest hover:scale-105 transition-all shadow-xl shadow-indigo-900/40 whitespace-nowrap"
                    >
                        + Schedule
                    </button>
                </div>
            ...
            <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
                ...
                <div className="w-full lg:w-[260px] xl:w-[320px] h-[160px] lg:h-full border-b lg:border-b-0 lg:border-r border-white/5 flex flex-col overflow-hidden bg-white/[0.01] shrink-0">
                    <div className="flex p-3 lg:p-4 border-b border-white/5 items-center justify-between bg-white/[0.02]">
                        ...
                        <span className="text-[12px] lg:text-[12px] font-black text-slate-500 uppercase tracking-widest italic">{filteredParticipants.length} SITE SUBJECTS</span>
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[12px] lg:text-[12px] font-black text-white italic uppercase tracking-wider">{p.id}</span>
                                    </div>
                                ...
                                <p className="text-[12px] lg:text-[12px] text-indigo-400/60 font-extrabold uppercase tracking-widest mb-3 lg:mb-4 italic truncate">{p.coordinator}</p>
                                <div className="flex items-center justify-between pt-3 lg:pt-4 border-t border-white/5">
                                    <div className="space-y-0.5">
                                        <p className="text-[12px] lg:text-[12px] text-slate-600 font-black uppercase tracking-widest">Next</p>
                                        <p className="text-[12px] lg:text-[12px] text-slate-300 font-mono font-black italic">{p.nextVisitDue}</p>
                                    </div>
                                    <span className="px-2 py-0.5 bg-white/5 rounded-md text-[12px] lg:text-[12px] font-black text-slate-500 uppercase italic">{p.status}</span>
                                </div>
                            </button>
                        ))}
                    </div>
                    ...
                    <div className="max-w-4xl mx-auto space-y-10 lg:space-y-16">
                        ...
                        <section>
                            <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 lg:mb-12 gap-6">
                                <div>
                                    ...
                                    <p className="text-[12px] text-indigo-400 font-black uppercase tracking-[0.2em] lg:tracking-[0.3em] mt-2 italic">#{selectedParticipant.id} • {selectedParticipant.study}</p>
                                </div>
                                <div className="flex flex-wrap items-center gap-3 lg:gap-4 pb-4 lg:pb-0">
                                    {['Overdue', 'Scheduled', 'Completed'].map(s => (
                                        <div key={s} className="flex items-center gap-2">
                                            ...
                                            <span className="text-[12px] font-black text-slate-600 uppercase italic">{s}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                                    ...
                                    {selectedParticipant.visits.map((visit, i) => (
                                        ...
                                        >
                                            ...
                                            <div className={`w-12 h-12 lg:w-14 lg:h-14 rounded-xl lg:rounded-2xl flex items-center justify-center border-2 lg:border-4 transition-all ${
                                                ...
                                                selectedVisitId === visit.id ? 'bg-indigo-800 border-indigo-600 shadow-[0_0_20px_rgba(79,70,229,0.4)]' : 
                        ...
                        <section className="pt-8 lg:pt-16 border-t border-white/5">
                            <div className="grid grid-cols-1 sm:grid-cols-2 2xl:grid-cols-2 gap-4 lg:gap-8">
                                <div className="p-5 lg:p-8 bg-indigo-500/5 border border-indigo-500/10 rounded-2xl lg:rounded-[2.5rem] flex items-center justify-between group min-h-[100px] lg:min-h-0">
                                    <div className="flex items-center gap-3 lg:gap-6">
                                        ...
                                        <div className="min-w-0">
                                            <p className="text-[12px] lg:text-[12px] text-indigo-400 font-black uppercase tracking-[0.2em] italic truncate">Adherence Index</p>
                                ...
                                <div className="p-5 lg:p-8 bg-white/5 border border-white/5 rounded-2xl lg:rounded-[2.5rem] flex flex-col justify-center min-h-[100px] lg:min-h-0">
                                    <p className="text-[12px] lg:text-[12px] text-slate-600 font-black uppercase tracking-widest italic mb-2 lg:mb-3 truncate">Next Target Window</p>
                                    <div className="flex items-center gap-3 lg:gap-4">
                                        <Calendar className="w-4 h-4 lg:w-5 lg:h-5 text-indigo-400 shrink-0" />
                                        <p className="text-[12px] lg:text-sm font-black text-white italic uppercase truncate">{selectedParticipant.nextVisitDue} <span className="text-slate-600 mx-1 lg:mx-2">±</span> {selectedVisit.window}</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <div className="p-5 lg:p-10 bg-white/[0.02] border border-white/5 rounded-2xl lg:rounded-[3rem] space-y-4 lg:space-y-6">
                            <div className="flex items-center gap-3 lg:gap-4 text-emerald-400 italic">
                                ...
                                <span className="text-[12px] lg:text-[12px] font-black uppercase tracking-[0.2em]">Scientific Summary Line</span>
                            </div>
                            <p className="text-[12px] lg:text-sm font-black text-slate-400 italic leading-relaxed uppercase tracking-tight break-words whitespace-normal">
                ...
                <div className="w-full lg:w-[350px] xl:w-[450px] border-t lg:border-t-0 lg:border-l border-white/5 flex flex-col lg:h-full overflow-hidden bg-white/[0.02] shrink-0 relative">
                    ...
                    <div className="p-6 lg:p-8 border-b border-white/5 bg-white/[0.01]">
                        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
                            <div className="space-y-1">
                                <h4 className="text-[12px] font-black text-slate-500 uppercase tracking-widest italic">{selectedVisit.name} DETAIL</h4>
                                <p className="text-[12px] text-indigo-400 font-black uppercase tracking-widest">#{selectedParticipant.id} • {selectedParticipant.coordinator}</p>
                            </div>
                            <span className={`px-2 py-1 rounded-lg text-[12px] font-black uppercase tracking-widest shrink-0 ${
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            <button className="flex-1 min-w-[180px] py-4 bg-indigo-700 text-white rounded-xl text-[12px] font-black uppercase tracking-widest shadow-xl shadow-indigo-900/40 hover:scale-[1.02] transition-all italic">Start Visit Sequence</button>
                        ...
                        <div className="border border-white/5 rounded-[2rem] overflow-hidden bg-white/[0.01]">
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-[12px] font-black text-white uppercase italic tracking-widest">Protocol Checklist</span>
                                </div>
                                    ...
                                    {selectedVisit.checklist.map((item, i) => (
                                        ...
                                        >
                                            <div className="flex items-center gap-3 lg:gap-4">
                                                ...
                                                <span className={`text-[12px] lg:text-[12px] font-black uppercase italic tracking-tight ${item.done ? 'text-slate-300' : 'text-slate-500'}`}>{item.item}</span>
                                            </div>

                                            {item.done && <span className="text-[12px] font-black text-indigo-400 uppercase tracking-tighter opacity-40 group-hover:opacity-100 transition-opacity font-mono">{item.time} • {item.user}</span>}
                                        </div>
                                    ))}
                                </div>
                            )}
                        ...
                        <div className="border border-white/5 rounded-[2rem] overflow-hidden bg-white/[0.01]">
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-[12px] font-black text-white uppercase italic tracking-widest">Anthropometry & Vitals</span>
                                </div>
                                ...
                                <div className="px-6 pb-6 space-y-6">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="p-4 bg-white/5 rounded-2xl border border-white/5 space-y-2">
                                            <p className="text-[12px] text-slate-600 font-black uppercase tracking-widest italic">Weight (kg)</p>
                                            <input 
                                                type="text" 
                                        ...
                                        <div className="p-4 bg-white/5 rounded-2xl border border-white/5 space-y-2">
                                            <p className="text-[12px] text-slate-600 font-black uppercase tracking-widest italic">Height (m)</p>
                                            <input 
                                                type="text" 
                                    ...
                                    <div className="p-6 bg-indigo-500/5 border border-indigo-500/10 rounded-2xl flex items-center justify-between">
                                        <div>
                                            <p className="text-[12px] text-indigo-400 font-black uppercase tracking-widest italic">Computed BMI</p>
                                            <p className="text-2xl font-black text-white italic mt-1">{bmi || 'N/A'}</p>
                                        </div>
                                        <span className={`px-3 py-1 rounded-lg text-[12px] font-black uppercase tracking-widest ${
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                         {[
                                             ...
                                             <div key={i} className="p-4 bg-white/5 rounded-2xl border border-white/5 space-y-2">
                                                 <p className="text-[12px] text-slate-600 font-black uppercase tracking-widest italic">{v.label}</p>
                                                 <div className="flex items-center gap-2">
                        ...
                        <div className="border border-white/5 rounded-[2rem] overflow-hidden bg-white/[0.01]">
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-[12px] font-black text-white uppercase italic tracking-widest">Intervention Adherence</span>
                                </div>
                                ...
                                <div className="px-6 pb-6 space-y-6">
                                    <div className="p-6 bg-white/5 border border-white/5 rounded-3xl space-y-4">
                                        <div className="flex items-center justify-between">
                                            <p className="text-[12px] text-slate-500 font-black uppercase italic">Current Dispensation</p>
                                            <span className="text-[12px] font-black text-indigo-400 font-mono tracking-widest">LOT #HI2026-X1</span>
                                        </div>
                                        <p className="text-xl font-black text-white uppercase italic tracking-wider">{selectedVisit.meds.dispensed}</p>
                                        <p className="text-[12px] text-slate-600 font-black uppercase italic">Dose Sequence: {selectedVisit.meds.dose} @ ID-887</p>
                                    </div>
                                    <div className="relative pt-6">
                                        <div className="flex items-center justify-between mb-3 text-[12px] font-black uppercase tracking-widest italic">
                         ...
                         <div className="p-6 border border-white/5 rounded-[2rem] bg-white/[0.01] flex items-center justify-between group cursor-pointer hover:border-white/10 transition-all">
                             <div className="flex items-center gap-4">
                                ...
                                <span className="text-[12px] font-black text-white uppercase italic tracking-widest">Safety & Adverse Events</span>
                             </div>
                             <span className="text-[12px] font-black text-slate-700 uppercase italic">None Reported</span>
                         </div>
                    </div>
                    ...
                    <div className="sticky bottom-0 mt-auto p-6 lg:p-8 bg-[#0B101B]/95 border-t border-white/10 space-y-6 backdrop-blur-3xl z-20">
                        <div className="flex items-center gap-3">
                            ...
                            <p className="text-[12px] font-black text-slate-500 uppercase tracking-widest italic">Clinical Sign-off Authorization Required</p>
                        </div>
                        <div className="flex flex-col md:flex-row gap-4">
                            <button 
                                onClick={() => handleSignOff('Approve')}
                                className="w-full md:flex-1 py-4 bg-emerald-600 text-white rounded-2xl text-[12px] font-black uppercase tracking-widest shadow-xl shadow-emerald-900/40 hover:scale-[1.02] active:scale-95 transition-all italic flex items-center justify-center gap-2"
                            >
                                <CheckCircle2 className="w-4 h-4" /> Approve Visit
                            </button>
                            <button className="w-full md:flex-1 py-4 bg-white/5 border border-white/5 text-slate-400 rounded-2xl text-[12px] font-black uppercase tracking-widest hover:text-white transition-all italic">
                                Request correction
                            </button>
                            <button 
                        ...
                        <p className="text-[12px] text-slate-700 font-extrabold uppercase text-center italic tracking-widest">Digital signature will be appended upon biometric verification</p>
                    </div>
                </div>
            </div>
                        ...
                        >
                            <div className="flex items-center justify-between border-b border-white/5 pb-8">
                                <div>
                                    ...
                                    <p className="text-[12px] text-indigo-400 font-black uppercase tracking-[0.3em] mt-3 italic">Sync visit window with global GCP timing</p>
                                </div>
                            ...
                            <div className="grid grid-cols-2 gap-10">
                                <div className="space-y-4">
                                    <label className="text-[12px] text-slate-600 font-black uppercase tracking-widest italic">Participant ID</label>
                                ...
                                <div className="space-y-4">
                                    <label className="text-[12px] text-slate-600 font-black uppercase tracking-widest italic">Protocol Visit Type</label>
                                    <select className="w-full bg-white/5 border border-white/10 rounded-2xl px-8 py-5 text-sm font-black italic uppercase text-white outline-none appearance-none">
                                ...
                                <div className="space-y-4">
                                    <label className="text-[12px] text-slate-600 font-black uppercase tracking-widest italic">Scheduled Epoch</label>
                                    <div className="flex gap-4">
                                        <input type="date" className="flex-1 bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-[12px] font-mono font-black text-white outline-none" />
                                        <input type="time" className="flex-1 bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-[12px] font-mono font-black text-white outline-none" />
                                    </div>
                                </div>
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        {['Clinic Visit', 'Home Visit', 'Virtual Hub'].map(m => (
                                            <button key={m} className="px-4 py-4 bg-white/5 border border-white/10 rounded-2xl text-[12px] font-black uppercase tracking-widest italic text-slate-500 hover:text-white hover:border-indigo-500/50 transition-all">
                                                {m}
                                            </button>
                                        ))}
                                    </div>
                            ...
                            <div className="pt-12 border-t border-white/5 flex items-center justify-between">
                                <button onClick={() => setIsScheduleOpen(false)} className="px-10 py-5 text-[12px] font-black text-slate-700 uppercase tracking-widest hover:text-white">Cancel Alignment</button>
                                <div className="flex gap-6">
                                    <button className="px-10 py-5 bg-white/5 border border-white/5 text-slate-400 rounded-3xl text-[12px] font-black uppercase tracking-widest">Save Temporary Draft</button>
                                    <button 
                                        onClick={() => setIsScheduleOpen(false)}
                                        className="px-14 py-5 bg-indigo-600 text-white rounded-3xl text-[12px] font-black uppercase tracking-widest shadow-2xl shadow-indigo-900/40 hover:scale-105 transition-all italic"
                                    >
