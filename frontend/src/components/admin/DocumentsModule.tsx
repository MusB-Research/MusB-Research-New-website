                ...
                <div className="lg:col-span-8 space-y-6">
                    <div className="bg-[#0B101B]/40 backdrop-blur-3xl border border-white/5 rounded-[3.5rem] p-10">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                             <div className="flex items-center gap-4 text-[12px] font-black uppercase tracking-widest text-slate-500 italic">
                                <span>Root</span>
                             ...
                             <div className="relative">
                                ...
                                <input type="text" placeholder="Find documents..." className="bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-2 text-[12px] text-white outline-none focus:border-cyan-500/50 transition-all w-48 font-bold uppercase tracking-widest"/>
                             </div>
                        </div>
                             ...
                             <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                                {['Protocols', 'Consent', 'SOPs', 'Legal'].map((f, i) => (
                                    <div key={i} className="p-6 bg-white/5 border border-white/5 rounded-3xl group hover:border-cyan-500/30 transition-all cursor-pointer">
                                        ...
                                        <p className="text-[12px] font-black text-white uppercase italic tracking-tight">{f}</p>
                                        <p className="text-[12px] text-slate-600 font-bold uppercase tracking-widest mt-1">12 Files</p>
                                    </div>
                                ))}
                             </div>
                                        ...
                                        <div className="flex items-center gap-5">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-3 mt-1">
                                                    <span className="text-[12px] font-bold text-slate-600 uppercase tracking-widest italic">{doc.folder}</span>
                                                    <span className="w-1 h-1 rounded-full bg-slate-800" />
                                                    <span className="text-[12px] font-bold text-slate-600 uppercase tracking-widest">{doc.size}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-10">
                                            <div className="hidden md:block text-right">
                                                <p className="text-[12px] font-black text-slate-500 italic uppercase">Modified</p>
                                                <p className="text-[12px] font-bold text-white uppercase tracking-widest mt-1">{doc.date}</p>
                                            </div>
                        ...
                        <div className="space-y-6">
                             <div className="p-6 bg-indigo-500/5 border border-indigo-500/10 rounded-3xl space-y-4">
                                <div className="flex justify-between items-center">
                                    <p className="text-[12px] font-black text-indigo-400 uppercase italic tracking-tight">E-Consent Required</p>
                                    <span className="w-2.5 h-2.5 rounded-full bg-indigo-500 animate-pulse" />
                                </div>
                                <p className="text-[12px] text-slate-400 leading-relaxed font-bold uppercase tracking-widest">03 Participants awaiting investigator countersignature on Consent Form v1.2</p>
                                <button className="w-full py-4 bg-indigo-500 text-white rounded-2xl text-[12px] font-black uppercase tracking-widest shadow-xl shadow-indigo-500/20 hover:scale-[1.02] transition-all italic">Launch Sign Portal</button>
                             </div>

                             <div className="space-y-4">
                                <p className="text-[12px] font-black text-slate-500 uppercase tracking-widest italic ml-1">Recent Activity</p>
                                {[
                                    ...
                                    <div key={i} className="flex gap-4 p-4 bg-white/5 border border-white/5 rounded-2xl items-start">
                                        ...
                                        <div>
                                            <p className="text-[12px] font-bold text-slate-300 uppercase tracking-tight">{log.msg}</p>
                                            <p className="text-[12px] text-slate-600 font-bold uppercase tracking-widest mt-1">{log.time}</p>
                                        </div>
                                    </div>
                                ))}
                             </div>
