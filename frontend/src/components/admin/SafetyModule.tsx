        ...
        >
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex gap-4">
                    ...
                    <button className="px-8 py-4 bg-red-500 text-white rounded-[2rem] text-[12px] font-black uppercase tracking-widest italic flex items-center gap-3 shadow-xl shadow-red-500/20 hover:scale-[1.02] transition-all">
                        ...
                        <div className="flex items-center justify-between mb-8">
                             ...
                             <div className="flex gap-3">
                                <div className="relative">
                                    ...
                                    <input type="text" placeholder="Search events..." className="bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-2 text-[12px] text-white outline-none focus:border-red-500/50 transition-all w-48 font-bold uppercase tracking-widest"/>
                                </div>
                                    ...
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-3">
                                                <span className="text-[12px] font-black text-slate-600 uppercase tracking-widest italic">{event.id}</span>
                                                <span className={`px-2 py-0.5 rounded text-[12px] font-black uppercase tracking-widest border border-white/5 ${
                                            ...
                                            <p className="text-[12px] font-bold text-slate-500 uppercase tracking-widest mt-1">Subject: {event.participant}</p>
                                        </div>
                                    </div>

                                    <div className="flex items-center gap-8 pl-16 md:pl-0">
                                        <div className="text-right">
                                            <p className="text-[12px] font-black text-white italic uppercase">{event.date}</p>
                                            <p className="text-[12px] font-bold text-slate-600 uppercase tracking-widest mt-1">System Log Time</p>
                                        </div>
                    ...
                    <div className="bg-[#0B101B]/40 backdrop-blur-3xl border border-white/5 rounded-[3rem] p-10 space-y-8">
                        ...
                        <div className="space-y-6">
                            <div className="p-6 bg-red-500/5 border border-red-500/10 rounded-3xl space-y-4">
                                <p className="text-[12px] font-black text-red-400 uppercase italic tracking-tight">On-Call Medical Monitor</p>
                                <div className="space-y-2">
                                    <p className="text-lg font-black text-white italic">+1 (888) 902-SAFE</p>
                                    <p className="text-[12px] font-bold text-slate-500 uppercase tracking-widest">Global 24/7 Response Line</p>
                                </div>
                                <button className="w-full py-3 bg-red-500 text-white rounded-2xl text-[12px] font-black uppercase tracking-widest hover:scale-[1.02] transition-all">Initiate Protocol Call</button>
                            </div>
                            <div className="space-y-4">
                                <p className="text-[12px] font-black text-slate-500 uppercase tracking-widest italic ml-1">Safety Guidelines</p>
                                <div className="space-y-2">
                                    {['SAE Reporting Window', 'MedDRA Coding Guide', 'Case Resolution SLA'].map(item => (
                                        <button key={item} className="w-full flex items-center justify-between p-4 bg-white/5 border border-white/5 rounded-2xl hover:border-white/10 transition-all group">
                                            <span className="text-[12px] font-bold text-slate-400 uppercase tracking-widest group-hover:text-white">{item}</span>
