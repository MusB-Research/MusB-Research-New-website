        ...
        >
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex gap-4">
                    ...
                    <button className="px-8 py-4 bg-indigo-500 text-white rounded-[2rem] text-[12px] font-black uppercase tracking-widest italic flex items-center gap-3 shadow-xl shadow-indigo-500/20 hover:scale-[1.02] transition-all">
                ...
                <div className="lg:col-span-12">
                    <div className="bg-[#0B101B]/40 backdrop-blur-3xl border border-white/5 rounded-[3.5rem] p-10 grid md:grid-cols-4 gap-10">
                        <div className="space-y-4">
                            <p className="text-[12px] font-black text-slate-500 uppercase tracking-widest italic">Database Integrity</p>
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[12px] font-bold text-slate-500 uppercase tracking-widest mt-1">Synced 4m ago</p>
                                </div>
                            </div>
                        </div>
                        <div className="space-y-4">
                            <p className="text-[12px] font-black text-slate-500 uppercase tracking-widest italic">Missing Datapoints</p>
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[12px] font-bold text-slate-500 uppercase tracking-widest mt-1">Requires Cleanup</p>
                                </div>
                            </div>
                        </div>
                        <div className="space-y-4">
                            <p className="text-[12px] font-black text-slate-500 uppercase tracking-widest italic">Total Records</p>
                        ...
                        <div className="space-y-4">
                            <p className="text-[12px] font-black text-slate-500 uppercase tracking-widest italic">Schema Version</p>
                            <div className="flex items-center gap-4">
                ...
                <div className="lg:col-span-7 space-y-6">
                    <div className="bg-[#0B101B]/40 backdrop-blur-3xl border border-white/5 rounded-[3.5rem] p-10 space-y-8">
                        ...
                        <div className="space-y-8">
                            <div className="grid grid-cols-2 gap-4">
                                {[
                                    ...
                                    <div key={i} className="p-6 bg-white/5 border border-white/5 rounded-[2.5rem] hover:border-indigo-500/30 transition-all cursor-pointer group">
                                        ...
                                        <p className="text-[12px] text-slate-500 font-bold uppercase tracking-widest mt-1">{item.size}</p>
                                    </div>
                                ))}
                            </div>

                            <div className="space-y-4">
                                <p className="text-[12px] font-black text-slate-500 uppercase tracking-widest italic ml-1">Export Format Configuration</p>
                                <div className="grid grid-cols-4 gap-3">
                                    {['CSV', 'JSON', 'SAS', 'CDISC'].map(format => (
                                        <button key={format} className={`py-3 rounded-xl text-[12px] font-black uppercase tracking-widest border transition-all ${format === 'CSV' ? 'bg-indigo-500 text-white border-indigo-500' : 'bg-white/5 text-slate-500 border-white/10 hover:text-white'}`}>
                                            {format}
                                        </button>
                                    ))}
                                </div>
                            ...
                            <button className="w-full py-6 bg-white/5 border border-white/10 text-white rounded-[2.5rem] font-black text-[12px] uppercase tracking-[0.3em] hover:bg-white hover:text-slate-950 transition-all flex items-center justify-center gap-4 italic group">
                        ...
                        <div className="space-y-6">
                             {[
                                ...
                                <div key={i} className="flex items-center justify-between p-4 bg-white/5 border border-white/5 rounded-2xl group hover:border-white/10 transition-all">
                                    <div>
                                        <p className="text-[12px] font-black text-white uppercase italic tracking-tight">{pipe.name}</p>
                                        <p className="text-[12px] text-slate-500 font-bold uppercase tracking-widest mt-1">Load Balance: {pipe.load}</p>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className={`text-[12px] font-black uppercase tracking-widest ${pipe.color}`}>{pipe.status}</span>
                                    </div>
                                </div>
                             ))}
                        </div>
