                ...
                {[
                    ...
                    <div key={stat.label} className="bg-[#0B101B]/40 backdrop-blur-3xl border border-white/5 rounded-[2.5rem] p-8 flex items-center justify-between group hover:border-white/10 transition-all">
                        <div className="space-y-2">
                            ...
                            <p className={`text-[12px] font-bold uppercase ${stat.color} flex items-center gap-1`}>
            ...
            <div className="grid lg:grid-cols-12 gap-8">
                    ...
                    <div className="bg-[#0B101B]/40 backdrop-blur-3xl border border-white/5 rounded-[3.5rem] p-10">
                        <div className="flex items-center justify-between mb-8">
                             ...
                             <div className="relative">
                                ...
                                <input type="text" placeholder="Search SKU..." className="bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-2 text-[12px] text-white outline-none focus:border-cyan-500/50 transition-all w-48 font-bold uppercase tracking-widest"/>
                             </div>
                        </div>
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="border-b border-white/5">
                                        <th className="pb-6 text-[12px] font-black uppercase tracking-widest text-slate-500 italic">SKU / Item</th>
                                        <th className="pb-6 text-[12px] font-black uppercase tracking-widest text-slate-500 italic">Location</th>
                                        <th className="pb-6 text-[12px] font-black uppercase tracking-widest text-slate-500 italic">Quantity</th>
                                        <th className="pb-6 text-[12px] font-black uppercase tracking-widest text-slate-500 italic text-right">Status</th>
                                    </tr>
                                </thead>
                                            ...
                                            <td className="py-6">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-[12px] text-slate-500 font-bold uppercase tracking-widest mt-1">{item.sku}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="py-6">
                                                <span className="text-[12px] font-black text-slate-400 uppercase tracking-widest italic">{item.location}</span>
                                            </td>
                                            <td className="py-6">
                                                <span className="text-sm font-black text-white italic tracking-tighter">{item.stock}</span>
                                            </td>
                                            <td className="py-6 text-right">
                                                <span className={`px-4 py-1.5 rounded-full text-[12px] font-black uppercase tracking-widest border border-white/5 ${
                ...
                <div className="lg:col-span-4 space-y-8">
                    <div className="bg-[#0B101B]/40 backdrop-blur-3xl border border-white/5 rounded-[3rem] p-8 space-y-6 overflow-hidden">
                            ...
                            {[
                                ...
                                <div key={i} className="p-5 bg-white/5 border border-white/5 rounded-[2rem] space-y-4 group hover:border-cyan-500/30 transition-all">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            <p className="text-[12px] font-black text-white italic uppercase tracking-tight">{ship.id}</p>
                                            <p className="text-[12px] text-slate-500 font-bold uppercase tracking-widest mt-1">Dest: {ship.to}</p>
                                        </div>
                                        <span className={`text-[12px] font-black uppercase tracking-widest ${ship.status === 'Delayed' ? 'text-red-400' : 'text-cyan-400'}`}>{ship.status}</span>
                                    </div>
                                    <div className="space-y-2">
                                        <div className="flex justify-between text-[12px] font-black text-slate-600 uppercase tracking-[0.2em]">
                                            <span>Progress</span>
                        ...
                        <button className="w-full py-4 bg-white/5 border border-white/10 text-white rounded-2xl font-black text-[12px] uppercase tracking-widest hover:bg-white hover:text-slate-950 transition-all italic">Launch Global Tracker</button>
                    </div>
                    ...
                    <div className="bg-red-500/5 border border-red-500/10 rounded-[2.5rem] p-8 flex items-center gap-6">
                        ...
                        <div>
                            <p className="text-red-400 font-black text-[12px] uppercase italic tracking-tighter">04 Items Near Expiry</p>
                            <p className="text-[12px] text-slate-500 font-bold uppercase tracking-widest mt-1">Require immediate rotation</p>
                        </div>
                    </div>
                </div>
            </div>
