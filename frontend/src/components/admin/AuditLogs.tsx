      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-[12px] font-black text-pink-500 uppercase tracking-[0.3em]">Security Intelligence</span>
          </div>
        ...
        <div className="flex items-center gap-4">
          <button className="px-6 py-3 bg-white/5 border border-white/10 rounded-xl text-[12px] font-black uppercase tracking-widest text-slate-400 hover:text-white transition-all flex items-center gap-2 italic">
        ...
        {[
          ...
          <div key={i} className="bg-white/[0.02] border border-white/5 p-6 rounded-[2rem] hover:bg-white/[0.04] transition-all group">
            <div className="flex items-start justify-between mb-4">
              ...
              <span className={`text-[12px] font-black px-2 py-1 rounded-full bg-${stat.color}-500/10 text-${stat.color}-500`}>
                {stat.trend}
              </span>
            </div>
            <p className="text-[12px] font-black text-slate-500 uppercase tracking-widest mb-1">{stat.label}</p>
        ...
        <div className="p-8 border-b border-white/5 bg-white/[0.01] flex flex-col md:flex-row justify-between gap-6">
          <div className="relative group w-full md:w-96">
            ...
            <input 
              ...
              className="w-full bg-slate-950/50 border border-white/10 rounded-2xl pl-16 pr-8 py-5 text-white font-bold outline-none focus:border-pink-500/50 focus:ring-4 focus:ring-pink-500/10 transition-all text-[12px] uppercase tracking-widest placeholder:text-slate-800"
            />
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex bg-slate-950/50 p-1.5 rounded-2xl border border-white/5">
              {['ALL', 'SECURITY', 'DATA', 'USER'].map((t) => (
                <button key={t} className="px-6 py-3 text-[12px] font-black uppercase tracking-widest text-slate-500 hover:text-white rounded-xl transition-all">
                  {t}
                </button>
              ))}
            </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-white/5 bg-white/[0.01]">
                <th className="px-10 py-6 text-[12px] font-black text-slate-500 uppercase tracking-[0.2em]">Operator Info</th>
                <th className="px-10 py-6 text-[12px] font-black text-slate-500 uppercase tracking-[0.2em]">Action Type</th>
                <th className="px-10 py-6 text-[12px] font-black text-slate-500 uppercase tracking-[0.2em]">Environmental Data</th>
                <th className="px-10 py-6 text-[12px] font-black text-slate-500 uppercase tracking-[0.2em]">Status</th>
                <th className="px-10 py-6 text-[12px] font-black text-slate-500 uppercase tracking-[0.2em] text-right italic">Temporal Hash</th>
              </tr>
            </thead>
              ...
              {filteredLogs.map((log) => (
                <tr key={log.id} className="hover:bg-pink-500/[0.02] transition-colors group">
                  <td className="px-10 py-8">
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 text-[12px] font-bold text-slate-500 uppercase tracking-widest italic">
                  ...
                  <td className="px-10 py-8">
                    ...
                    <div className="flex items-center gap-2 text-[12px] font-bold text-slate-600 uppercase tracking-widest">
                  ...
                  <td className="px-10 py-8">
                    <span className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-[12px] font-black uppercase tracking-widest border ${
                  ...
                  <td className="px-10 py-8 text-right">
                    <button className="p-3 text-slate-700 hover:text-white transition-all bg-white/[0.02] rounded-xl border border-white/5 opacity-0 group-hover:opacity-100 italic font-mono text-[12px]">
                      View Trace
                    </button>
                    <div className="text-[12px] font-mono text-slate-800 uppercase tracking-widest mt-2">
