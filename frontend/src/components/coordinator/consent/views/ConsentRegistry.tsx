...
interface ConsentRegistryProps {
    ...
    setAuditDrawerRecordId: (id: string) => void;
    setAuditDrawerOpen: (open: boolean) => void;
}

export const ConsentRegistry: React.FC<ConsentRegistryProps> = ({
    consentRecords,
    recordsFilter,
    setRecordsFilter,
    recordsSearch,
