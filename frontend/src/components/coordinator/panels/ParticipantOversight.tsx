                                ...
                                <tr>
                                    <td colSpan={5} className="py-20 text-center">
                                        <div className="flex flex-col items-center gap-4">
                                            ...
                                            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-indigo-400 animate-pulse italic">Synchronizing Participant Registry...</p>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <td className="px-3 md:px-5 py-4 md:py-6 whitespace-nowrap align-middle">
                                        <div className="flex items-center gap-2 md:gap-3">
                                            ...
                                            <div className="min-w-0">
                                                ...
                                                <p className="text-[9px] md:text-[10px] text-white/30 font-black tracking-widest mt-0.5 md:mt-1 uppercase font-mono">SID: {p.participant_sid} <span className="mx-1 md:mx-2 text-indigo-500/30">/</span> {p.study}</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-3 md:px-5 py-4 md:py-5 align-middle">
                                        <div className="w-32 md:w-44 space-y-2 md:space-y-2.5">
                                            <div className="flex justify-between items-center px-1">
                                                <span className="text-[9px] font-black text-white/40 uppercase tracking-[0.1em] italic">Protocol Compliance</span>
