            ...
            <div className={`grid ${isMobile ? 'grid-cols-1' : isTablet ? 'grid-cols-2' : 'grid-cols-4'} gap-6`}>
                {[
                    ...
                    <div 
                        ...
                        className={`flex items-center gap-6 p-5 bg-white/[0.02] border border-white/5 rounded-[2rem] shadow-xl group cursor-pointer transition-all ${
                            activeCategory === q.cat ? 'opacity-100 scale-[1.02] border-indigo-500/30 bg-white/[0.04]' : 'opacity-60 hover:opacity-100'
                        }`}
                    >
