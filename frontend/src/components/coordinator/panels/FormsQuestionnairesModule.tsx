        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-10">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                <div>
                    ...
                    <p className="text-[12px] text-white/50 font-bold uppercase tracking-[0.2em] md:tracking-[0.4em] mt-3 md:mt-4 italic">eCRF Management & Dynamic Instrument Design</p>
                </div>
                            ...
                            {[
                                ...
                                <div key={i} className="bg-[#0F172A] border border-white/10 rounded-2xl md:rounded-[3rem] p-6 md:p-8 space-y-4 md:space-y-6 hover:border-indigo-500/40 transition-all group overflow-hidden relative shadow-2xl shadow-black/40">
                                    ...
                                    <div className="flex items-center gap-4 md:gap-5 relative z-10">
                                        ...
                                        <span className="text-[12px] text-white/50 font-black uppercase tracking-widest italic leading-tight">{stat.label}</span>
                                    </div>
                            ...
                            <table className="w-full text-left min-w-[900px]">
                                <thead>
                                    <tr className="bg-white/5 border-b border-white/10">
                                        <th className="w-[30%] px-6 py-6 text-[12px] font-black text-white/80 uppercase tracking-widest italic border-r border-white/5">eCRF Instrument</th>
                                        <th className="w-[15%] px-6 py-6 text-[12px] font-black text-white/80 uppercase tracking-widest italic text-center border-r border-white/5">Subject ID</th>
                                        <th className="w-[20%] px-6 py-6 text-[12px] font-black text-white/80 uppercase tracking-widest italic text-center border-r border-white/5">Protocol Visit</th>
                                        <th className="w-[20%] px-6 py-6 text-[12px] font-black text-white/80 uppercase tracking-widest italic text-center border-r border-white/5">Form Health</th>
                                        <th className="w-[15%] px-6 py-6 text-[12px] font-black text-white/80 uppercase tracking-widest italic text-right">Actions</th>
                                    </tr>
                                </thead>
