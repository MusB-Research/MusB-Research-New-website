        ...
        <div className="w-[380px] border-l border-white/5 flex flex-col overflow-y-auto custom-scrollbar p-10 space-y-12 bg-white/[0.02]">
                ...
                <div className="space-y-6">
                    {[
                        ...
                        { label: 'Creation Epoch', val: selectedTicket.createdAt, icon: Clock }
                         ...
                         <div key={i} className="flex flex-col gap-2 p-5 bg-white/5 border border-white/10 rounded-2xl">
                            <span className="text-[12px] font-black text-slate-600 uppercase tracking-[0.2em] flex items-center gap-2 italic">
                                <item.icon className="w-3.5 h-3.5" /> {item.label}
                            </span>
                            <span className="text-[13px] font-black text-white uppercase italic tracking-widest leading-none">{item.val}</span>
                        </div>
                    ))}
                </div>
            </section>
            ...
            <section>
                ...
                <div className="grid gap-3">
                     <label className="text-[12px] text-slate-700 font-bold uppercase tracking-widest mb-1 block italic">Governance State</label>
                ...
                <div className="space-y-6">
                    <div className="relative pl-6 border-l border-indigo-500/20 space-y-6">
                         <div className="relative">
                            ...
                            <p className="text-[12px] text-slate-700 mt-1 uppercase italic font-mono">{selectedTicket.createdAt}</p>
                        </div>
                         <div className="relative">
                            ...
                            <p className="text-[12px] text-slate-700 mt-1 uppercase italic font-mono">Within 2 Hours</p>
                        </div>
                    </div>
                </div>
            </section>
