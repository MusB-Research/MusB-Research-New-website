                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar p-16 space-y-16">
                            <section className="grid grid-cols-2 gap-10">
                                <div className="space-y-4">
                                    ...
                                    <input type="text" placeholder="Summary of the incident..." className="w-full bg-white/5 border border-white/10 rounded-2xl px-8 py-5 text-[15px] font-black italic uppercase text-white placeholder-slate-800 outline-none focus:border-indigo-500/50" />
                                </div>
                                <div className="space-y-4">
                                    <label className="text-[12px] text-slate-500 font-black uppercase tracking-widest italic">Incident Category</label>
                                    <select className="w-full bg-white/5 border border-white/10 rounded-2xl px-8 py-5 text-[15px] font-black italic uppercase text-white outline-none focus:border-indigo-500/50 appearance-none">
                                ...
                                <div className="col-span-2 space-y-4">
                                    ...
                                    <textarea placeholder="Describe the behavior or required clarification in detail..." className="w-full bg-white/5 border border-white/10 rounded-[2rem] px-8 py-6 text-[15px] font-black italic uppercase text-white placeholder-slate-800 outline-none focus:border-indigo-500/50 h-32 resize-none" />
                                </div>
                            </section>
                             ...
                             <section className="grid grid-cols-3 gap-8">
                                <div className="space-y-4">
                                    ...
                                    <select className="w-full bg-white/5 border border-white/10 rounded-xl px-6 py-4 text-[13px] font-black uppercase text-white outline-none appearance-none">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <input type="text" placeholder="BTB-XXX" className="w-full bg-white/5 border border-white/10 rounded-xl px-6 py-4 text-[13px] font-black uppercase text-white placeholder-slate-800 outline-none font-bold" />
                                </div>
                            </section>
                             ...
                             <div className="p-12 bg-indigo-500/5 border border-indigo-500/10 rounded-[3rem] flex flex-col items-center justify-center text-center gap-6 group hover:border-indigo-500/30 transition-all border-dashed">
                                ...
                                <div>
                                    <p className="text-[14px] font-black text-white uppercase italic">Append Scientific Evidence</p>
                         ...
                         <div className="flex-shrink-0 px-12 py-10 bg-[#0B101B]/95 backdrop-blur-xl border-t border-white/5 flex items-center justify-between">
                            <button onClick={onClose} className="px-10 py-4 text-[12px] font-black text-slate-600 uppercase tracking-widest hover:text-white transition-colors">Abort Submission</button>
                            <div className="flex gap-4">
                                <button className="px-10 py-4 bg-white/5 border border-white/10 text-slate-400 rounded-2xl text-[12px] font-black uppercase tracking-widest hover:text-white transition-all">Save Temporary Draft</button>
                                <button 
                                    onClick={onClose}
