...
export default function ConsortiumForm({ 
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            body.append('message', formData.purpose);
    ...
    const formContent = (
        <div className={`relative w-full ${isInline ? 'bg-white/5' : 'max-w-2xl bg-[#0a1120]'} border border-white/10 rounded-[2rem] p-6 md:p-10 shadow-2xl overflow-hidden h-full`}>
