        ...
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    ...
                    <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.3em] mt-2 italic">
                        Control research protocols, deadlines, and compliance rules.
                    </p>
                </div>
                <button 
                    onClick={() => setShowNewTaskModal(true)}
                    className="flex items-center gap-2 px-6 py-3 bg-white text-slate-900 rounded-2xl text-[11px] font-black uppercase tracking-widest hover:scale-[1.02] transition-all shadow-xl"
                >
                ...
                <div className="p-8 border-b border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4 bg-white/5 border border-white/10 px-5 py-2.5 rounded-2xl flex-1 max-w-md group focus-within:border-cyan-500/50 transition-all">
                        ...
                        <input 
                            ...
                            className="bg-transparent border-none outline-none text-white text-[11px] font-black tracking-widest uppercase w-full"
                            value={searchQuery}
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-white/[0.02]">
                                <th className="px-10 py-6 text-[10px] font-black text-slate-500 uppercase tracking-widest">Participant / Study</th>
                                <th className="px-10 py-6 text-[10px] font-black text-slate-500 uppercase tracking-widest">Mission Title</th>
                                <th className="px-10 py-6 text-[10px] font-black text-slate-500 uppercase tracking-widest">Deadline</th>
                                <th className="px-10 py-6 text-[10px] font-black text-slate-500 uppercase tracking-widest">Status / Intelligence</th>
                                <th className="px-10 py-6 text-[10px] font-black text-slate-500 uppercase tracking-widest text-right">Operational Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            {tasks.map((task) => (
                                <tr key={task.id} className="border-b border-white/5 group hover:bg-white/[0.01] transition-all">
                                    <td className="px-10 py-8">
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-xl bg-slate-800 flex items-center justify-center border border-white/10 italic font-black text-white text-xs">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-[10px] font-bold text-slate-600 uppercase tracking-widest">{task.protocol_id}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-10 py-8">
                                    ...
                                    <td className="px-10 py-8">
                                        <div className="flex flex-col gap-2">
                                            <div className={`px-4 py-1.5 rounded-full border text-[9px] font-black uppercase tracking-widest w-fit ${getStatusStyle(task.status)}`}>
                                                {task.status}
                                            </div>
                                    ...
                                    <td className="px-10 py-8 text-right">
                                        <div className="flex items-center justify-end gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <button className="p-3 bg-white/5 border border-white/10 text-slate-400 hover:text-white rounded-xl transition-all shadow-lg">
                                                <Shield className="w-4 h-4" />
                                            </button>
                                            <button className="px-6 py-3 bg-cyan-600 hover:bg-cyan-500 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all shadow-lg shadow-cyan-900/40">
                                                Override Rules
                                            </button>
                                        </div>
                                    </td>
                        ...
                        >
                            <div className="p-10 space-y-10">
                                <div>
                                    ...
                                    <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.3em] mt-2 italic">Configure protocol timing and compliance thresholds.</p>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Assign to Participant ID</label>
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Delay Allowed (Days)</label>
