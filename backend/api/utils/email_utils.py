              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td valign="middle" align="right" style="white-space:nowrap;padding-left:10px;">
                    ...
                    <a href="mailto:info@musbresearch.com" style="display:block;color:#2563EB;font-size:13px;font-weight:700;text-decoration:none;">info@musbresearch.com &rarr;</a>
                  </td>
                </tr>
              </table>
            </td>
...
def send_reminder_email(user_email: str, user_name: str, study_name: str, tasks: list) -> bool:
    ...
    try:
        ...
        from_email = f"MusB Research <{getattr(settings, 'SMTP_EMAIL', 'info@musbresearch.com')}>"
...
def send_musb_system_email(
    ...
    try:
        ...
        from_email = f"MusB Research <{getattr(settings, 'SMTP_EMAIL', None) or getattr(settings, 'EMAIL_HOST_USER', 'info@musbresearch.com')}>"
